...
class TestDirectorService {
    ...
    @Test
    void testSaveDirectorInvalidOscars() {
        Director director = Director.builder()
                .name("Steven")
                .lastName("Spielberg")
                .noOfOscars(-1)
        ...
        String expectedMessage = "Number of oscars for a director must be higher than 0!";
        String actualMessage = exception.getMessage();

        assertTrue(actualMessage.contains(expectedMessage), "Exception message should be 'Number of oscars for a director must be higher than 0!'");
    }
}
